...
These judges examine file formats, based on name or content."""
...
from garak.judges.base import FileJudge


class PossiblePickleName(FileJudge):
...
class FileIsExecutable(FileJudge):
    ...
    def _load_deps(self):
        try:
            ...
            logging.info(
                "judges.fileformats: failed importing python-magic, try installing libmagic, e.g. `brew install libmagic`",
                exc_info=e,
            )
            self.magic = None
