...
class LangChainServeLLMTarget(Target):
    ...
    Inherits from Garak's base Target class, extending its capabilities to support web-based LLM services.
    ...
    target_family_name = "LangChainServe"
    ENV_VAR = "LANGCHAIN_SERVE_URI"
    DEFAULT_PARAMS = Target.DEFAULT_PARAMS | {"config_hash": "default"}
...
DEFAULT_CLASS = "LangChainServeLLMTarget"
