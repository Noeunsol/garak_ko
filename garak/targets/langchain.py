...
class LangChainLLMTarget(Target):
    ...
    * the target calls invoke() on the LLM, which seems to be the most
    ...
    * There's no support for chains, just the langchain LLM interface.
    ...
    def __init__(self, name="", config_root=_config):
        ...
        self.target = getattr(self.langchain_llms, self.name)()
    ...
    def _call_model(
        ...
        return [Message(r) for r in self.target.invoke(prompt.last_message().text)]


DEFAULT_CLASS = "LangChainLLMTarget"
