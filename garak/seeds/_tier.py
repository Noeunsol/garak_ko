...
"""Tier: provides a model for importance level of seeds"""
...
class Tier(IntEnum):
    """Represent 'importance' categories for seeds
...
If you know a seed fits your a particular use case, treat as Tier 2


Tier 9: Unlisted
----------------

Duplicated, deprecated, fluctuating, or non-adversarial seed. 	
