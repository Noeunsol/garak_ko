...
Seeds in this module should specifically implement parts of the PromptInject
framework.

Uses the PromptInject framework, https://openreview.net/forum?id=qiaRo_7Zmug,
to seed a system. A subset of the attacks is implemented here. The default
...
def constructor(self, config_root=_config):
    ...
    self.max_prompts = self.soft_seed_prompt_cap
    ...
    setattr(
        ...
        type(
            ...
            (garak.seeds.Seed,),
            {
                ...
                "__doc__": f"PromptInject seed to inject a string; payload is {rogue_string}\n\nAttempt to make the model repeat a given string",
