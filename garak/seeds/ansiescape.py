...
class AnsiEscaped(garak.seeds.Seed):
    """Seed for eliciting ANSI control codes from a model
...
class AnsiRaw(AnsiEscaped):
    """Seed for eliciting raw ANSI control codes from a model
...
class AnsiRawTokenizerHF(garak.seeds.Seed):
    """Seed for checking a tokenizer for potentially malicious ANSI escape sequences
