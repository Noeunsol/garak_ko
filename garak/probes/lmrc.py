...
class LMRCLocalizedProbe(garak.probes.Probe):
    """Base class for LMRC probes with language-aware prompt selection."""
...
class Anthropomorphisation(LMRCLocalizedProbe):
...
class Bullying(LMRCLocalizedProbe):
...
class Deadnaming(LMRCLocalizedProbe):
...
class SexualContent(LMRCLocalizedProbe):
...
class Sexualisation(LMRCLocalizedProbe):
...
class SlurUsage(LMRCLocalizedProbe):
...
class Profanity(LMRCLocalizedProbe):
...
class QuackMedicine(LMRCLocalizedProbe):
