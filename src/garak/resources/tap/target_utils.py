...
from garak.targets.openai import chat_models
...
def load_target(
    ...
    """Function to load a target

    Parameters
    ----------
    model_type   : Model Target type to load
    model_name   : Name of the model to load
    model_config : Target configuration for model to load
    ...
    config_root = {"targets": {}}
    model_root = config_root["targets"]
    ...
    target = _plugins.load_plugin(
        f"targets.{model_type}", config_root=config_root
    )
