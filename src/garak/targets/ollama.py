...
class OllamaTarget(Target):
    ...
    DEFAULT_PARAMS = Target.DEFAULT_PARAMS | {
        ...
        "host": "127.0.0.1:11434",  # The default host of an Ollama server. This can be overwritten with a passed config or target config file.
    }

    active = True
    target_family_name = "Ollama"
...
class OllamaTargetChat(OllamaTarget):
...
DEFAULT_CLASS = "OllamaTargetChat"
