...
- [ ] Supporting configuration such as target configuration file
``` json
{
    "huggingface": {
        "torch_type": "float32"
...
- [ ] **Document** the thing and how it works ([Example](https://github.com/NVIDIA/garak/blob/61ce5c4ae3caac08e0abd1d069d223d8a66104bd/garak/targets/rest.py#L24-L100))
