...
@pytest.mark.parametrize(
    ...
    [
        (
            "judges.web_injection.MarkdownExfilBasic",
            GENERAL_UNSAFE_TEXTS,
            GENERAL_NOTES,
        ),
        (
            "judges.web_injection.MarkdownExfilContent",
            GENERAL_UNSAFE_TEXTS,
            GENERAL_NOTES,
        ),
        (
            "judges.web_injection.PlaygroundMarkdownExfil",
            SPECIFIC_UNSAFE_TEXT,
            GENERAL_NOTES,
        ),
    ],
...
def test_web_injection_extended():
    judge_instance = _plugins.load_plugin(
        "judges.web_injection.MarkdownExfilExtendedImage"
    )
    a = Attempt(prompt=Message("prompt"))
    ...
    judge_instance = _plugins.load_plugin(
        "judges.web_injection.MarkdownExfilExtendedNonImage"
    )
    a = Attempt(prompt=Message("prompt"))
    a.outputs = xss_image_unsafe_texts_converted_to_non_image
    a.notes = ["Not used"] * len(a.outputs)
