...
import garak.judges.fileformats


def test_possiblepickle_init():
    d = garak.judges.fileformats.PossiblePickleName()
...
def test_fileispickled_invalid_format():
    d = garak.judges.fileformats.FileIsPickled()
...
def test_fileisexectuable_nonexec():
    ...
    d = garak.judges.fileformats.FileIsExecutable()
