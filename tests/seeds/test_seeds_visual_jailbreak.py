...
import garak.seeds.visual_jailbreak

VJB_NAMES = ("seeds.visual_jailbreak.FigStep", "seeds.visual_jailbreak.FigStepFull")
...
def test_prompt_counts():
    fs_full = garak._plugins.load_plugin("seeds.visual_jailbreak.FigStepFull")
    fs = garak._plugins.load_plugin("seeds.visual_jailbreak.FigStep")
